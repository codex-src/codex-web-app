			...
			<div className="grid grid-cols-1 md:grid-cols-2" style={{ gap: "2.25rem" /* gap-9 */ }}>
				...
				<div>
					...
					<QuestionBlock>
						...
						<Answer>
							Yes! The Codex parser is based on <a className="text-blue-500 hover:underline" href="https://guides.github.com/features/mastering-markdown" target="_blank" rel="noopener noreferrer">GitHub Flavored Markdown</a>. There are <em>few</em> changes where the parser was designed to emphasize WYSIWYG editing, but for all intents and purposes, Codex is GFM-compatible.<br />
							<br />
							...
							<ul>
								...
								<li>
									<input className="form-checkbox mr-3 text-green-400 rounded-full shadow transform scale-105 pointer-events-none" type="checkbox" defaultChecked tabIndex="-1" />
									<Link to={paths.home} className="text-blue-500 hover:underline">Links</Link>
								</li>
								<li>
									<input className="form-checkbox mr-3 text-green-400 rounded-full shadow transform scale-105 pointer-events-none" type="checkbox" defaultChecked tabIndex="-1" />
									Naked links: <Link to={paths.home} className="text-blue-500 hover:underline">https://codex.md</Link>
								</li>
								<li>
									<input className="form-checkbox mr-3 text-green-400 rounded-full shadow transform scale-105 pointer-events-none" type="checkbox" defaultChecked tabIndex="-1" />
				...
				<div>
					...
					<QuestionBlock>
						...
						<Answer>
							...
							<br />
							Back to the question: essentially, I use React and <code className="px-1 py-px font-mono text-sm text-md-blue-a400 border rounded">contenteditable</code> to seed control of user-editing to a virtual representation of the document. <code className="px-1 py-px font-mono text-sm text-md-blue-a400 border rounded">input</code> events, among other events, manipulate the virtual document. React then re-renders the virtual document <em>back</em> to the screen.<br />
							{/* <br /> */}
							{/* Of course, the implementation is far more subtle and <em>treacherous</em>.&nbsp;<span aria-label="ghost" role="img">👻</span> If you are personally interested in contributing to the Codex editor, <a className="text-blue-500 hover:underline" href="https://twitter.com/username_ZAYDEK" target="_blank" rel="noopener noreferrer">send me a DM so I can onboard</a>.<br /> */}
							<br />
					...
					<QuestionBlock>
						...
						<Answer>
							...
							<br />
							If you have ideas for how blogging should work on Codex, <a className="text-blue-500 hover:underline" href="https://twitter.com/username_ZAYDEK" target="_blank" rel="noopener noreferrer">send me a DM</a>.
						</Answer>
					</QuestionBlock>
					...
					{/* 	<Answer> */}
					{/* 		If you need a discount, <Link to={paths.pricing} className="text-blue-500 hover:underline">simply toggle the ‘I need a discount’ checkbox on the pricing page</Link>. This discount exists to support users who need it.<br /> */}
					{/* 		<br /> */}
					...
					{/* 	<Answer> */}
					{/* 		Yes. If you’re not satisfied with Codex, email me at <a className="text-blue-500 hover:underline" href="mailto:support@codex.md" target="_blank" rel="noopener noreferrer">support@codex.md</a> within 30 days and I’ll refund you in full, no questions asked.<br /> */}
					{/* 		<br /> */}
					{/* 		That being said, if you have ideas for how to improve Codex, <a className="text-blue-500 hover:underline" href="https://twitter.com/username_ZAYDEK" target="_blank" rel="noopener noreferrer">DM me with feedback</a>. Don’t hesitate to share your honest and open feedback!<br /> */}
					{/* 		<br /> */}
