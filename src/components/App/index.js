	...
	return (
		<React.Fragment>
			...
			<div className="relative">
				...
				{/* RHS */}
				{/* NOTE: Use transition-all because of px-* */}
				<div className="px-6 flex-1 transition-all duration-500 ease-in-out" style={{ paddingTop: "4.5rem", paddingBottom: "4.5rem" /* py-18 */ }}>
					{/* NOTE: Uses paddingTop: 26 to match LHS;
					py-6 + (py-1 / 2) */}
					<div className="px-4 py-6 pt-7 fixed top-0 left-0 z-10 pointer-events-none" style={{ paddingTop: 26 }}>
					...
					>
						<div className="flex flex-row justify-center">
							<div className="w-full max-w-full lg:max-w-full-sidebar">
								<form>
									<div>
										<div>
											<div>
