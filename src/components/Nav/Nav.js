		...
		<div className="flex flex-row justify-between w-full max-w-screen-lg">
			...
			<div className="-mx-3 flex flex-row">
				...
				<div className="ml-6 mr-3 flex flex-row items-center">
					<Link className="px-4 py-3 flex flex-row items-center text-md-blue-a400 bg-white hover:bg-gray-100 border border-md-blue-a400 rounded-md tx-75" to="/auth" data-e2e="nav-cta-btn">
