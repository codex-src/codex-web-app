...
const Readme = ({ state, dispatch, ...props }) => {
	...
	return (
		<div
			...
			// onPointerEnter={dispatch.toggleReadme}
			// onPointerLeave={dispatch.toggleReadme}
		>
			{/* Hover area: */}
			...
			>
				...
				<div className="p-6 absolute right-0 top-0">
					<div className="p-2 text-gray-800 hover:bg-md-gray-100 active:bg-md-gray-200 rounded-full cursor-pointer" onClick={dispatch.toggleReadme}>
