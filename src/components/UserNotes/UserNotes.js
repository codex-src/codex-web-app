...
const UserNotes = props => (
	<NavContainer>
		<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
			<Link className="pb-2/3 relative bg-white hover:bg-gray-50 rounded-xl shadow-hero trans-150">
			...
			{[...new Array(20)].map((_, index) => (
				<Link key={index} className="pb-2/3 relative bg-white hover:bg-gray-50 rounded-lg shadow-hero overflow-y-hidden trans-150">
